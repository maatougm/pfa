...
<div class="max-w-5xl mx-auto">
  ...
  <div class="bg-white rounded-xl shadow-lg p-6 mb-10">
    <h2 class="text-2xl font-bold mb-4">🏆 Liste des trophées</h2>
    <table class="w-full text-sm table-auto border-collapse mb-6">
      <thead class="bg-yellow-300">
        <tr>
          <th class="p-2 text-left">Catégorie</th><th>Années</th><th>Sport</th><th>Image</th><th></th>
        </tr>
      </thead>
      <tbody>
        <tr class="bg-gray-50">
          <td class="p-2">Ligue CAF</td><td>2018, 2019</td><td>Football</td>
          <td><img src="https://via.placeholder.com/40" class="w-10"></td>
          <td><button class="text-red-500 hover:text-red-700">🗑️</button></td>
        </tr>
      </tbody>
    </table>
    <h3 class="text-xl font-semibold mb-2">➕ Ajouter un trophée</h3>
    <form class="grid grid-cols-2 gap-4">
      <input type="text" placeholder="Catégorie" class="input">
      <input type="text" placeholder="Années (virgule)" class="input">
      <input type="url" placeholder="URL image" class="input">
